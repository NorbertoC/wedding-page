		...
		<div className="w-full bg-white py-16 flex flex-col items-center box-border break-words my-16 ">
			...
			<div className="py-16 px-16 text-base font-gotham">
				<p>The first time I saw him, we were both sitting at the same gate for a flight to San Diego. I remember
					...
					<br/><br/>
					Well, he did. We started talking, and then he asked for my number and we went our separate ways. I was certain
					I would never hear from him again. I thought about him often, but eventually he faded into the ‘missed
					connections’ category. A few months later, out of the blue, he sent me [a message that said] ‘Happy New Year.’
					We hit it off like nothing ever changed.</p>
			</div>
		</div>
	);
}